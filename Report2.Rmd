...
::::::
\ 
Now we apply the logistic function to the linear combination of the weights of the model of Table ## multiplied to the attributes of the new standardized diamond of Table #, so that we map the output of the linear model in the interval [0,1]:
$$
