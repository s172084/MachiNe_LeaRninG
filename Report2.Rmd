 ...
 **Neural Network**         **Ridge Regression Model**         **Baseline**
...
### Question 3 
**Statistically Evaluate if there is a significant performance difference between the fitted ANN, linear **
**regression model and baseline, using the methods in Chapter 11.**
