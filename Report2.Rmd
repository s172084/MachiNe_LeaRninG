...
The vector of c (1) indicates 1 hidden layer, with 1 node in the Neural Network (see Figure D in the Appendix) . The vector of c(3, 3) indicates 2 hidden layers with 3 nodes in each respective layer of this Artificial Neural Network (see figure E in the Appendix) . 
