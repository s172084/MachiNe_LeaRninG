...
baseline?} \textbf{Are some of the models identical? What
...
difference in mean squared errors between the models is statistically
significant.

Evaluation of the values from the Artificial Neural Network against the
values from the Baseline show that the p-value is less than 2.2e-16 and
the confidence interval is - 3009.865 up to - 3009.776 . This indicates
that the null hypothesis can be rejected.

Evaluation of the values from the Regularised Linear Regression against
values from the Baseline, Show that the p-value is 1 and the confidence
interval is - 166 up to 166 . This indicates that the null hypothesis
can be accepted.

Evaluation of the values from the Artificial Neural Network against the
Regularised Linear Regression, show that p-value is 2.2e-16 and the
confidence interval is - 3176.502 up to - 2843.138. This indicates that
