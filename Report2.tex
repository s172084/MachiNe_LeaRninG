...
{Table \#: estimated weights of the LRL}
...
{Table \#: estimated weights of the LRQ applied to the Principal
Components}
...
\begin{col}{0.50\textwidth}
\includegraphics{Images/PC_coeff.png} {Figure \#: coefficients of the
...
Figure \# represents how each of the Principal Components depends on the
seven attributes. Looking at the weights of the Table \#, it can be
...
diamonds (green and cyan bars of Figure \#). The result agrees with the
Figure \#\#, showing the almost clear clusters wherein data projected
onto the space defined by the second and third Principal Components
fall.
