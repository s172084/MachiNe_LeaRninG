...
\[Y_{ridge} = X \times  (X'X + \lambda I)^ {-1}{X'Y})\] The Figure B
shows that the carat is the attribute with the highest permutation
importance and the highest variable importance.
